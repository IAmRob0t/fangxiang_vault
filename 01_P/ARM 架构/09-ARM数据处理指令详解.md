...
![](attachments/09-ARM数据处理指令详解/file-20251119154000175.png)
...
![](attachments/09-ARM数据处理指令详解/file-20251119154000176.png)

## 2.2 条件执行后缀 `{cond}`

`{cond}` 决定了指令是否执行，它依赖于 APSR 中标志位的当前状态。

![](attachments/09-ARM数据处理指令详解/file-20251119154000170.png)
...
![](attachments/09-ARM数据处理指令详解/file-20251119154000169.png)
