...
![](attachments/09_ARM数据处理指令详解/file-20251119160024701.png)
...
![](attachments/09_ARM数据处理指令详解/file-20251119160024700.png)

## 2.2 条件执行后缀 `{cond}`

`{cond}` 决定了指令是否执行，它依赖于 APSR 中标志位的当前状态。

![](attachments/09_ARM数据处理指令详解/file-20251119160024702.png)
...
![](attachments/09_ARM数据处理指令详解/file-20251119160024704.png)
