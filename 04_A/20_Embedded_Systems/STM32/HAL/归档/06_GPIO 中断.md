...
![[HAL快速入门与项目实战.pdf#page=58&rect=160,602,445,673|HAL快速入门与项目实战, p.58]]
...
![[HAL快速入门与项目实战.pdf#page=59&rect=149,644,448,747&color=note|HAL快速入门与项目实战, p.59]]
...
![[HAL快速入门与项目实战.pdf#page=59&rect=103,84,449,186|HAL快速入门与项目实战, p.59]]
...
![[HAL快速入门与项目实战.pdf#page=60&rect=159,550,461,660|HAL快速入门与项目实战, p.60]]

沿着中断信号从源头（比如某个 GPIO 引脚），如何一路发给 CPU，简述各个部件的功能：
- **GPIO：可以配置某个引脚能否发出中断信号**
	- 如下图，PA0~PG0 这多个 0 号引脚中，同一时间只能有一个连接到 EXTI0，即**它们中同一时间只能有一个被用作中断引脚**，可以在 AFIO_EXTICR1 寄存器中选择某个引脚。 ![[STM32F103xx参考手册(英文原版).pdf#page=210&rect=232,280,392,738|STM32F103xx参考手册(英文原版), p.210]]
	- 外部中断共有 20 条中断线
	...
	- 芯片手册中有 AFIO_EXTICR1 寄存器的描述： 
		- ![[STM32F103xx参考手册(英文原版).pdf#page=191&rect=60,488,534,756|STM32F103xx参考手册(英文原版), p.191]]
...
- **CPU：CPU内部也有一个开关，是否使能CPU处理中断**
	...
	- ![[HAL快速入门与项目实战.pdf#page=63&rect=138,337,459,455|HAL快速入门与项目实战, p.63]]
...
![[HAL快速入门与项目实战.pdf#page=64&rect=103,240,503,340|HAL快速入门与项目实战, p.64]]
...
> ![[HAL快速入门与项目实战.pdf#page=65&rect=114,531,495,662|HAL快速入门与项目实战, p.65]]
...
![[STM32F103xx参考手册(英文原版).pdf#page=192&rect=61,220,531,484|STM32F103xx参考手册(英文原版), p.192]]
...
![[HAL快速入门与项目实战.pdf#page=66&rect=236,207,384,440|HAL快速入门与项目实战, p.66]]

# 使用 OLED 进行调试

本节程序源码为“0602_key_isr_oled”，在“0601_key_isr”的基础上修改得来。

![[04_A/STM32/原理图/DshanMCU-F103_baseboard.pdf#page=1&rect=38,243,192,321|DshanMCU-F103_baseboard, p.1]]

## 1. STM32CuMX 配置

OLED 屏幕使用 I2C1 通道，I2C1 使用 PB6、PB7 作为 SCL、SDA 引脚，配置如下：

![[HAL快速入门与项目实战.pdf#page=68&rect=110,514,487,733|HAL快速入门与项目实战, p.68]]
...
![[HAL快速入门与项目实战.pdf#page=68&rect=202,80,414,270|HAL快速入门与项目实战, p.68]]
...
![[HAL快速入门与项目实战.pdf#page=72&rect=152,453,443,681|HAL快速入门与项目实战, p.72]]
...
![[HAL快速入门与项目实战.pdf#page=72&rect=117,131,480,343|HAL快速入门与项目实战, p.72]]
...
![[HAL快速入门与项目实战.pdf#page=73&rect=234,509,359,608|HAL快速入门与项目实战, p.73]]

环形缓冲区的工作原理如下图所示：

![[HAL快速入门与项目实战.pdf#page=73&rect=145,181,447,497|HAL快速入门与项目实战, p.73]]
