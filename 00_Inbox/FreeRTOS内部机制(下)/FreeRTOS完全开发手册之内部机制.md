...
![image-20210712065106008](02_program_with_rtos.png)
...
![image-20211211070259111](01_cpu_ram.png)
...
![image-20211211070449003](02_cpu_registers.png)
...
![image-20211211072941967](03_cpu_reg_names.png)
...
![image-20220115073423273](01_task_create_example.png)
...
![image-20220115074535364](02_freertos_task_list.png)
...
![image-20220115075019776](03_freertos_first_task.png)
...
![image-20220115075511170](04_freertos_get_highest_task.png)
...
![](13_full_task_state_machine.png)
...
![image-20220115080857803](04_enter_critical.png)
...
![image-20220115081434247](05_queue_list.png)
...
* 超时：
  ...
  * 系统Tick中断不断发生，在Tick中断里判断delayed list中的任务时间到没？时间到后就唤醒它
    ![image-20220115083023870](14_queue_timeout.png)



* 别的任务读队列:
  ![image-20220115083303252](15_wakeup_task_for_queue.png)



## 5. 信号量(semaphore)

![](01_semaphore_usage.png)
...
![image-20220115084012905](01_mutex_example.png)
...
![image-20220115084249887|588](01_event_group_example.png)



### 7.1 核心是：关调度器、位操作、链表

![image-20220115084647032](02_event_group_struct.png)
...
![image-20220115084828616](03_event_group_suspendall.png)
...
* 设置位：
  ![image-20220115130744356](04_set_bits.png)



* 等待位
  ![image-20220115130955806](05_wait_bits.png)
...
* 设置位后，会唤醒"所有符合条件"的任务
  ![image-20220115133147523](06_wakeup_task_for_event_group.png)
* 等待位的时候，条件不满足则会休眠
  ![image-20220115132918706](07_block_for_event_group.png)
...
![image-20220115133310665](01_block.png)
...
![image-20220115133807283](02_tasknotify_in_tcb.png)
